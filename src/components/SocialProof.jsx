...
const UnsplashIcon = () => (
  <svg width="34" height="32" viewBox="0 0 32 32" fill="#A6A6A6" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 9V0h12v9H10zm12 5h10v18H0V14h10v9h12v-9z"/>
  </svg>
);
const NotionIcon = () => (
  <svg width="34" height="32" viewBox="0 0 100 100" fill="#A6A6A6" xmlns="http://www.w3.org/2000/svg">
...
const DescriptIcon = () => (
  <svg width="34" height="32" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="32" height="32" rx="6" fill="#A6A6A6"/>
...
export default function SocialProof() {
  return (
    <section className="section-mint" style={S.section}>
      <div className="container" style={S.inner}>
        <h3 className="social-proof-title" style={S.title}>More than 25,000 teams use Collabs</h3>
        <div className="social-proof-row" style={S.row}>
...
const S = {
  ...
  row: {
    ...
    gap: 36, flexWrap: 'nowrap', width: '100%',
  },
  item: {
